...
public class lex {
    ...
    public static void main(String[] args) throws FileNotFoundException{
        File plc = new File("D:\\documents\\PLCpractical.txt"); //Change depending on where File is located in your drive
        FileReader p = null;
            try{
                ...
                else if(statement.contains("for") && statement.contains("{") && statement.contains("}") && statement.contains("(") && statement.contains(")") && statement.contains(";")) {
                    System.out.println("\n FOR STATEMENT- \n");    
                    System.out.println(statement);           
               	}
